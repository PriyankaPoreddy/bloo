...
public class showDocAppointmentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_show_doc_appointment);
        ...
        selectDate = (TextView) findViewById(R.id.showAppointment_selectedDate);
        ...
        selectDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                datePickerDialog = new DatePickerDialog(showDocAppointmentActivity.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
    ...
    private void viewAppointment() {
        ...
        FirebaseRecyclerAdapter<BookedAppList, DoctorShowAppointmentVH> firebaseRecyclerAdapter =
                new FirebaseRecyclerAdapter<BookedAppList, DoctorShowAppointmentVH>(firebaseRecyclerOptions) {
                    @Override
                    protected void onBindViewHolder(@NonNull final DoctorShowAppointmentVH holder, final int position, @NonNull final BookedAppList model) {
...
//                                Toast.makeText(Doctor_ShowAppointmentActivity.this, slot, Toast.LENGTH_SHORT).show();
    ...
    private void alertDialog(final String patientID, final String slot) {
        ...
        count = 0;
        AlertDialog.Builder builder = new AlertDialog.Builder(showDocAppointmentActivity.this);
...
//                                Toast.makeText(Doctor_ShowAppointmentActivity.this, Integer.toString(count), Toast.LENGTH_SHORT).show();
    ...
    public class DoctorShowAppointmentVH extends RecyclerView.ViewHolder{
        ...
        public void setTime(String time) {
            TextView textView = (TextView) mView.findViewById(R.id.single_pat_time);
            textView.setText(time);
        }

        public void setName(String name) {
            TextView mName = (TextView) mView.findViewById(R.id.single_patName);
            mName.setText(name);
        }
